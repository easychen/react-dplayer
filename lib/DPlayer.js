...
function _clsx2() {
  var data = _interopRequireDefault(require("clsx"));

  _clsx2 = function _clsx2() {
    return data;
  };
...
function _dplayer() {
  var data = _interopRequireDefault(require("dplayer"));

  _dplayer = function _dplayer() {
    return data;
  };
  ...
  _createClass(DPlayerComponent, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.props.options !== prevProps.options) {
        this.dp = new (_dplayer().default)(_objectSpread(_objectSpread({}, Object.assign({}, {
          lang: 'zh-cn',
          contextmenu: []
        }, this.props.options)), {}, {
    ...
    value: function render() {
      ...
      var resetProps = (0, _omit.default)(otherProps, ['options', 'onLoad'].concat(_toConsumableArray(eventsProps.map(function (ev) {
        return ev.prop;
      }))));
      var wrapperClassName = (0, _clsx2().default)((_clsx = {}, _defineProperty(_clsx, "dplayer", true), _defineProperty(_clsx, "".concat(className), !!className), _clsx));
